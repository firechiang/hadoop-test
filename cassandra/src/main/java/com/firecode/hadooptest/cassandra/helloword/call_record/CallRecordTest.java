...
public class CallRecordTest {
	...
	public void save() {
		...
		callRecord1.setId(1L);
		callRecord1.setDnumPhone("13143457382");
		callRecord1.setType(1);
		callRecord1.setLength(12);
		callRecord1.setCreateTime(new Date());
		
		CallRecord callRecord2 = new CallRecord();
		callRecord2.setId(2L);
		callRecord2.setDnumPhone("13143457382");
		callRecord2.setType(1);
		callRecord2.setLength(12);
		callRecord2.setCreateTime(new Date());
		
		CallRecord callRecord3 = new CallRecord();
		callRecord3.setId(3L);
		callRecord3.setDnumPhone("13143457382");
		callRecord3.setType(1);
		callRecord3.setLength(12);
		callRecord3.setCreateTime(new Date());
		
		CallRecord callRecord4 = new CallRecord();
		callRecord4.setId(4L);
		callRecord4.setDnumPhone("13143457382");
		callRecord4.setType(1);
		callRecord4.setLength(12);
		callRecord4.setCreateTime(new Date());
		
		mapper.save(callRecord1);
		mapper.save(callRecord3);
		mapper.save(callRecord2);
		mapper.save(callRecord4);
    }
