...
public class RightJoin_use {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSource<Tuple2<Integer, String>> dataSource2 = env.fromCollection(Arrays.asList(new Tuple2<>(1, "第一"), new Tuple2<>(2, "第二"), new Tuple2<>(3, "第三"),new Tuple2<>(5, "4444")));
		// 连接dataSource2，where(0)是指左边用哪个属性做连接，equalTo(0)是指右边用哪个属性做连接；0都是取的Tuple2<>的Key
		JoinFunctionAssigner<Tuple2<Integer, String>, Tuple2<Integer, String>> equalTo = dataSource1.rightOuterJoin(dataSource2).where(0).equalTo(0);
		// 处理连接后的结果集数据		
