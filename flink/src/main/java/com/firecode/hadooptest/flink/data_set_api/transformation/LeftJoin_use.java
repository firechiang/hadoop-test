...
public class LeftJoin_use {
	...
	public static void main(String[] args) throws Exception {
		...
		JoinFunctionAssigner<Tuple2<Integer, String>, Tuple2<Integer, String>> equalTo = dataSource1.leftOuterJoin(dataSource2).where(0).equalTo(0);
		// 处理连接后的结果集数据		
